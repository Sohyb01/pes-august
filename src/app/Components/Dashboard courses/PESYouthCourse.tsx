...
import { deletePesYouthCourse_SA } from "@/app/actions/delete-pes-youth-course";
import Modal from "react-modal";

function PESYouthCourse(props: {
  data: {
    id: number;
    courseName: string;
          ...
          <div className="flex flex-col gap-8 w-full md:grid grid-cols-2">
            ...
            <div className="col-span-2 flex gap-8">
              ...
              <button
                ...
                onClick={() => {
                  deletePesYouthCourse_SA(props.data.id);
                  closeModal();
                }}
              >
                Delete
