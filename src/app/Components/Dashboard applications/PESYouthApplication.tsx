...
function PESYouthApplication(props: {
  data: {
        ...
        <section className=" text-neutral-800 section__styles rounded-[15px] p-4">
          <div className="flex flex-col gap-8 w-full md:grid grid-cols-2">
            ...
            <div className="input-field-and-label">
              ...
              <p className="text-neutral-800">{props.data.StudentUniversity}</p>
            </div>
            <div className="input-field-and-label">
              <p className="text-neutral-500">University</p>
              <p className="text-neutral-800">{props.data.StudentCollege}</p>
            </div>
            <div className="input-field-and-label">
              <p className="text-neutral-500">University</p>
              <p className="text-neutral-800">
                {props.data.StudentSpeciality || "?"}
              </p>
            </div>
            <div className="input-field-and-label">
...
export default PESYouthApplication;
